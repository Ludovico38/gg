    ...
    public void saveMagazziniere() {
        try {
            ...
            if (magazziniere.getId() == -1) {
                magazzinoDAO.insertMagazzinieri(magazziniere.getId(), magazziniere.getNome(), magazziniere.getCognome(), magazziniere.getCodiceFiscale(), magazziniere.getDataDiNascita(), magazziniere.getPatente(), magazziniere.getIdVeicolo());
            } else {
                magazzinoDAO.updateMagazziniere(magazziniere.getId(), magazziniere.getNome(), magazziniere.getCognome(), magazziniere.getCodiceFiscale(), magazziniere.getDataDiNascita(), magazziniere.getPatente(), magazziniere.getIdVeicolo());
            }
            this.loadMagazzinieri();
        } catch (MagazzinoException ex) {
