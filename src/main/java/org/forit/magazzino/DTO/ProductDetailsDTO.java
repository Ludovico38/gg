...
public class ProductDetailsDTO {
    ...
    public ProductDetailsDTO(String nome, BigDecimal prezzo_vendita, String provenienza, LocalDate scadenza, long id_scaffale, String categoria, BigDecimal prezzo_acquisto, int quantita_acquistati, BigDecimal spesa_totale, int quantita_venduti, BigDecimal ritorno, String nome_fornitore) {
        this.nome = nome;
